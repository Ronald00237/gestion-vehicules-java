...
public class VehicleControllerTest {
    ...
    public void  shouldReturnAllVehicles()throws Exception{
        ...
        Vehicle vehicle1 = new Vehicle("LIST-VIN-001",
                "LIST-PLATE-001",
                "Toyota",
                "Corolla",
                2020,
        ...
        Vehicle vehicle2 = new Vehicle("LIST-VIN-002",
                "LIST-PLATE-002",
                "Toyota",
                "Corolla",
                2020,
        ...
        public void shouldFindVehicleById() throws Exception {
            ...
            public void shouldReturnNotFoundWhenVehicleIdDoesNotExist() throws Exception {
                ...
                mockMvc.perform(get("/api/v1/vehicles/{id}", unknownId)).andExpect(status().isNotFound());
            }

    @Test
    public void shouldReturnEmptyListWhenNoVehicleExists() throws Exception {
        mockMvc.perform(get("/api/v1/vehicles"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$").isArray())
